...
def _load_trajectory(data: dict[str, Any] | None) -> TrajectoryConfig:
    ...
    return TrajectoryConfig(
        ...
        outlier_rejection_enabled=bool(data.get("outlier_rejection_enabled", True)),
        outlier_rejection_chi2_threshold=float(data.get("outlier_rejection_chi2_threshold", 9.0)),
        outlier_rejection_window_s=float(data.get("outlier_rejection_window_s", 40.0)),
